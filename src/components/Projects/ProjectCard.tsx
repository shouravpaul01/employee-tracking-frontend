...
export default function ProjectCard({ i ,isClickable}: { i: number, isClickable?:boolean}) {
  const router=useRouter()
  return (
    <div className="bg-white p-4 border rounded-lg space-y-2" onClick={()=>{isClickable && router.push(`/admin/projects/${i}`)}}>
      <div className="flex">
